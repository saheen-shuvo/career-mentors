...
const Banner = () => {
  return (
    <div className="carousel w-full mt-5">
      ...
      <p className="text-center text-xs lg:text-sm">Unlock the path to your ideal career with expert strategies, job search tips, and personalized advice. Let us guide you toward your dream job with confidence.</p>
      </div>
        <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
          <a href="#slide2" className="btn btn-circle">
            ❮
